...
3. Each captain must use `!roll` once in the match's chatroom. After the rolls are set, the pick and ban phase will have the following steps:
   - The winner of the roll decides either the pick _or_ the ban order; that is, they may pick from one of the following: first pick, first ban, second pick, or second ban.
